  ...
  getBMICategory(bmi) {
    if (bmi < 18.5) {
      return {
        ...
        class: "underweight",
        advice:
          "Il tuo BMI indica sottopeso. Considera di consultare un nutrizionista per un piano alimentare equilibrato che ti aiuti a raggiungere un peso salutare in modo graduale e sicuro.",
      };
    } else if (bmi < 25) {
      return {
        name: "Peso Normale",
        class: "normal",
        advice:
          "Complimenti! Il tuo BMI è nella norma. Mantieni uno stile di vita attivo con esercizio regolare e una dieta equilibrata per preservare la tua salute ottimale.",
      };
    } else if (bmi < 30) {
      return {
        name: "Sovrappeso",
        class: "overweight",
        advice:
          "Il tuo BMI indica sovrappeso. Considera di adottare abitudini più salutari: aumenta l'attività fisica, riduci le porzioni e scegli cibi nutrienti. Consulta un professionista per un piano personalizzato.",
      };
    } else {
      return {
        name: "Obesità",
        class: "obese",
        advice:
          "Il tuo BMI indica obesità. È importante consultare un medico per valutare i rischi per la salute e sviluppare un piano di gestione del peso sicuro ed efficace.",
      };
    }
  }
