(function () {
  ...
  document.querySelectorAll('.hand').forEach(el => el.style.animation = 'none');
  ...
  function generateTimeline(chrono) {
    ...
    const hours = ['06','08','10','12','14','16','18','20','22','00','02'];
    const labels = ['6h','8h','10h','12h','14h','16h','18h','20h','22h','0h','2h'];

    const energyMap = {
      early:   ['medium','high','peak','high','medium','medium','low','low','low','low','low'],
      neutral: ['low','medium','high','peak','high','medium','medium','low','low','low','low'],
      late:    ['low','low','low','medium','medium','high','peak','high','medium','low','low'],
    };
    const levels = energyMap[chrono];

    timeline.innerHTML = levels.map((lvl, i) => `
  ...
  function updateAdvice(chrono) {
    ...
    const data = {
      early:   {
        sleep: '21:30 → 05:30', sleepDetail: '8 ore · alba naturale',
        creative: '09:00 – 11:00', sport: '10:30 – 12:00',
        meals: '07:30 / 12:30 / 19:00', relax: '20:30',
        caffeine: 'Ultimo caffè entro le 14:00',
      },
      neutral: {
        sleep: '22:30 → 06:30', sleepDetail: '8 ore · ritmo standard',
        creative: '10:00 – 12:00', sport: '15:00 – 17:00',
        meals: '08:30 / 13:00 / 20:00', relax: '21:30',
        caffeine: 'Ultimo caffè entro le 15:30',
      },
      late:    {
        sleep: '00:30 → 08:30', sleepDetail: '8 ore · recupero profondo',
        creative: '16:00 – 18:00', sport: '18:00 – 20:00',
        meals: '10:00 / 14:00 / 21:30', relax: '23:30',
  ...
  function handleAnswer(questionId, value) {
    ...
    const btn = document.querySelector(`#${questionId} .opt-btn[data-value="${value}"]`);
    if (btn) {
