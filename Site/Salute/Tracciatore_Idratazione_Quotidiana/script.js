  ...
  function updateUI() {
    ...
    if (percentage < 25) {
      waterLevel.style.background =
        "linear-gradient(180deg, var(--primary-light) 0%, var(--danger) 100%)";
      percentageCircle.style.stroke = "var(--danger)";
    } else if (percentage < 50) {
      waterLevel.style.background =
        "linear-gradient(180deg, var(--primary-light) 0%, var(--warning) 100%)";
      ...
      waterLevel.style.background =
        "linear-gradient(180deg, var(--primary-light) 0%, var(--success) 100%)";
