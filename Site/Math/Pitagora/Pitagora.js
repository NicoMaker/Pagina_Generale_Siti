function calcola() {
  ...
  if (inputType === "ipotenusa") ipotenusa(risultatoElement, cateto1, cateto2);
  else if (inputType === "cateto") Cateto(risultatoElement);
}
...
document.getElementById("input-type").addEventListener("change", function () {
  let ipotenusaInputs = document.getElementById("ipotenusa-inputs"),
    catetoInputs = document.getElementById("cateto-inputs");
...
function Cateto(risultatoElement) {
  let ipotenusa = parseFloat(document.getElementById("ipotenusa").value),
    cateto = parseFloat(document.getElementById("cateto").value);
  ...
  if (cateto > ipotenusa) {
    risultatoElement.innerHTML =
      "Il cateto deve essere minore o uguale all'ipotenusa.";
    return;
  }
