document.addEventListener('DOMContentLoaded', function () {
    ...
    if (canvas) {
        ...
        const circumferenceMeasurement = document.getElementById('circumference-measurement');
        ...
        function drawCircle() {
            ...
            if (showSector) {
                ...
                ctx.moveTo(centerX, centerY);
                ctx.lineTo(centerX + radius * Math.cos(sectorAngle), centerY + radius * Math.sin(sectorAngle));
                ctx.strokeStyle = '#4361ee';
                ctx.lineWidth = 1;
                ctx.stroke();
        ...
        if (showDiameterBtn) {
            showDiameterBtn.addEventListener('click', function () {
                ...
                this.textContent = showDiameter ? 'Nascondi Diametro' : 'Mostra Diametro';
        ...
        if (showCircumferenceBtn) {
            showCircumferenceBtn.addEventListener('click', function () {
                ...
                this.textContent = showCircumference ? 'Nascondi Circonferenza' : 'Mostra Circonferenza';
                this.classList.toggle('active');
                drawCircle();
            });
        }
    ...
    function animateOnScroll() {
        const elements = document.querySelectorAll('.card, .formula-card, .application-item');
