document.addEventListener("DOMContentLoaded", () => {
  ...
  // Modifica la funzione checkWinner per correggere il problema di rilevamento della vittoria

  // Sostituisci la funzione checkWinner attuale con questa versione corretta:
