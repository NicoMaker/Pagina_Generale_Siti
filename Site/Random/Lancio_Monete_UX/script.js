class CoinFlipApp {
  ...
  bindEvents() {
    ...
    this.toggleHistory.addEventListener("click", () =>
  ...
  updateHistoryDisplay() {
    if (this.history.length === 0) {
      this.historyList.innerHTML =
        '<div class="empty-history">Nessun lancio effettuato</div>';
      return;
    }
