document.addEventListener("DOMContentLoaded", () => {
  ...
  function clearEvents() {
    showConfirmModal("Sei sicuro di voler eliminare tutti gli impegni per questa data?", true)
  }
  ...
  function handleDeleteEvent(e) {
    ...
    if (event) {
      showConfirmModal(`Sei sicuro di voler eliminare l'impegno "${event.description}"?`, false, eventId)
    }
  }
