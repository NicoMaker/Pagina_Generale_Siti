...
document.addEventListener("DOMContentLoaded", () => {
  ...
  mapMarkers.forEach((marker) => {
    marker.addEventListener("click", () => {
      ...
      if (data) {
        ...
        marker.querySelector(".marker-dot").style.backgroundColor = "var(--secondary)"
  ...
  clearBtn.addEventListener("click", () => {
    ...
    resultDiv.innerHTML = '<div class="placeholder-text">Il testo cifrato o decifrato apparirà qui</div>'
    inputText.focus()
  })
  ...
  copyBtn.addEventListener("click", () => {
    ...
    textarea.value = resultText.replace("Testo cifrato: ", "").replace("Testo decifrato: ", "")
  ...
  // Set Caesar image
  if (caesarImage) {
    caesarImage.src = "https://upload.wikimedia.org/wikipedia/commons/8/8f/Gaius_Iulius_Caesar_%28Vatican_Museum%29.jpg"
    caesarImage.alt = "Busto di Giulio Cesare"
  }

  // Page load animations
  const animatedElements = document.querySelectorAll(".hero-title, .hero-subtitle, .hero-dates, .hero-cta")
