...
// ── Avvia countdown ──────────────────────────────────────────────────────────
function startCountdown(targetDate, prefix, celebrationId, countdownContainerId) {
  const pre = prefix ? prefix + "-" : "";
  ...
  function tick() {
    ...
    if (distance <= 0) {
      ...
      if (cel) { cel.style.display = "flex"; cel.classList.add("fade-in"); }
      return;
    }
...
function launchConfetti() {
  const colors = ["#f7739a", "#60b8f5", "#d4a843", "#c4f5c4", "#d8b5ff", "#ffda85"];
  for (let i = 0; i < 80; i++) {
...
function initParticles() {
  ...
  const COLORS = ["#ffc2d9","#a5d8ff","#c4f5c4","#ffda85","#d8b5ff","#ffb6c1"];
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (isEasterDay) {
    ...
    setText("main-subtitle", "Che la gioia di questo giorno illumini il tuo cuore");
    ...
    setText("pasquetta-date", pasquettaThis.toLocaleDateString("it-IT", localeOpts));
    show("pasquetta-countdown-container");
    hide("pasquetta-celebration-message");
    startCountdown(pasquettaThis, "pasquetta", "pasquetta-celebration-message", "pasquetta-countdown-container");
  ...
  // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
    ...
    startCountdown(easterNext, "", "celebration-message", "countdown-container");

    // Pasquetta: celebrazione Lunedì dell'Angelo
    setText("pasquetta-section-title", "È Pasquetta!");
    setText("pasquetta-date", pasquettaThis.toLocaleDateString("it-IT", localeOpts));
    setText("pasquetta-desc", "Il Lunedì dell'Angelo è tradizionalmente dedicato alle gite fuori porta e ai picnic all'aperto con amici e familiari.");
  ...
  // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
    ...
    setText("pasquetta-date", pasquettaNext.toLocaleDateString("it-IT", localeOpts));
    hide("pasquetta-celebration-message");
    show("pasquetta-countdown-container");
    startCountdown(pasquettaNext, "pasquetta", "pasquetta-celebration-message", "pasquetta-countdown-container");
  }
  ...
  // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
    ...
    hide("celebration-message");
    show("countdown-container");
    startCountdown(easterThis, "", "celebration-message", "countdown-container");
  ...
  document.getElementById("pasquetta-celebrate-btn")?.addEventListener("click", launchConfetti);
