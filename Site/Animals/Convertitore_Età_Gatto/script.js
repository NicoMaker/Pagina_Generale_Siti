...
function convertAge() {
    ...
    let funFact;
    if (humanAge < 15) {
        funFact = "I gattini crescono incredibilmente veloce! A 6 mesi hanno già l'equivalente di 10 anni umani e sono pronti per esplorare il mondo.";
    } else if (humanAge < 25) {
        funFact = "I gatti giovani sono nel pieno dell'energia! Questo è il momento perfetto per socializzare e giocare molto con loro.";
    } else if (humanAge < 40) {
        funFact = "Il tuo gatto è nel fiore degli anni! Ha raggiunto il perfetto equilibrio tra energia giovanile e saggezza adulta.";
    } else if (humanAge < 60) {
        funFact = "I gatti di mezza età diventano spesso più affettuosi e rilassati. Apprezzano di più i momenti di coccole e tranquillità.";
    } else {
        funFact = "I gatti anziani sono tesori di saggezza! Meritano cure extra speciali e tutto il nostro amore per la loro lunga esperienza di vita.";
    }
...
document.addEventListener('mouseleave', function () {
    ...
    converterCard.style.transform = 'perspective(1000px) rotateY(0deg) rotateX(0deg)';
...
document.querySelector('.alert-content button').addEventListener('click', function (e) {
    addRippleEffect(this, e);
});
