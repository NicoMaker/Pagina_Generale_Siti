document.addEventListener("DOMContentLoaded", () => {
    ...
    function initializeSolarSystem() {
        ...
        Object.keys(planetData).forEach((planetKey) => {
            ...
            // Posiziona il pianeta sull'orbita con animazione
            const orbitDuration = planet.orbitPeriod
            ...
            planetElement.style.setProperty("--orbit-radius", `${planet.orbitRadius}px`)
            planetElement.style.animation = `orbit ${orbitDuration}s linear infinite`
