...
async function initializeApp() {
  ...
  try {
    ...
    showErrorModal("Errore nel caricamento dei dati zodiacali. Verifica la connessione internet.")
  }
}
...
function getFallbackZodiacData() {
  return [
    ...
    },
    {
      ...
      fine: "06-20",
      Elemento: "Aria",
      Caratteristiche: "Curioso, comunicativo, adattabile, intelligente, versatile",
    },
    {
      segno: "Cancro",
      inizio: "06-21",
    ...
    },
    {
      ...
      fine: "09-22",
      Elemento: "Terra",
      Caratteristiche: "Analitico, preciso, riservato, perfezionista, servizievole",
    },
    {
      segno: "Bilancia",
      inizio: "09-23",
    ...
    },
    {
      ...
      fine: "11-21",
      Elemento: "Acqua",
      Caratteristiche: "Intenso, passionale, misterioso, determinato, magnetico",
    },
    {
      segno: "Sagittario",
      inizio: "11-22",
      fine: "12-21",
      Elemento: "Fuoco",
      Caratteristiche: "Avventuroso, ottimista, filosofico, libero, esploratore",
    },
    {
      segno: "Capricorno",
      inizio: "12-22",
      fine: "01-19",
      Elemento: "Terra",
      Caratteristiche: "Ambizioso, responsabile, pragmatico, determinato, paziente",
    },
    {
      segno: "Acquario",
      inizio: "01-20",
      fine: "02-19",
      Elemento: "Aria",
      Caratteristiche: "Innovativo, indipendente, visionario, altruista, originale",
    },
    {
      segno: "Pesci",
      inizio: "02-20",
      fine: "03-20",
      Elemento: "Acqua",
      Caratteristiche: "Sensibile, intuitivo, spirituale, compassionevole, artistico",
    },
  ]
}
...
function setupEventListeners() {
  ...
  document.querySelectorAll(".month-btn").forEach((btn) => {
    btn.addEventListener("click", () => selectMonth(Number.parseInt(btn.dataset.month)))
  })
...
function validateInput() {
  ...
  calculateBtn.disabled = !isValidDay || !hasMonth || isCalculating || !dataLoaded

  if (statusMessage.textContent && !statusMessage.classList.contains("loading")) {
...
async function calculateZodiacSign() {
  ...
  if (day > daysInMonth) {
    showStatusMessage(`Il mese selezionato ha solo ${daysInMonth} giorni`, "error")
    return
  }
...
function createSignCard(sign) {
  const periodi = sign.periodi
    ? sign.periodi.map((p) => `${formatDate(p.inizio)} - ${formatDate(p.fine)}`).join(", ")
